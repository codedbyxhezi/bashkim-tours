          ...
          steps: [
            {
              ...
              text: "Zgjidh drejtimin dhe datën që të përshtatet më shumë.",
            },
            {
              number: "02",
              title: "Rezervo biletën",
              text: "Rezervo shpejt dhe lehtë përmes WhatsApp.",
            },
            {
              number: "03",
              title: "Udhëto",
              text: "Hipu në autobus dhe shijo një udhëtim të rehatshëm.",
            },
          ],
        }
      : {
