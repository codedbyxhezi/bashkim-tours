...
const content =
  locale === "mk"
    ? {
        badge: "Информации",
        title: "Важни информации за вашето патување",
        text: "Прочитајте ги најважните правила и информации пред вашето патување.",
        items: [
          {
            title: "Здравствени правила и осигурување",
            text: "Патникот е должен да се информира кај соодветната здравствена институција и да ги почитува здравствените правила за патување во одредена земја. Во случај на болест или несреќа за време на користење на нашата услуга, медицинските трошоци ги покрива патникот. Затоа препорачуваме патниците да направат патничко осигурување.",
          },
          {
            title: "Правила за багаж",
            text: "Дозволени се најмногу 2 патни куфери по патник со вкупна тежина до 30 кг. За деца и бебиња е дозволен 1 куфер до 15 кг. Забранет е транспорт на велосипеди, спортска опрема, скии, музички инструменти, наркотични средства, експлозиви и други опасни предмети.",
          },
          {
            title: "Алкохол и тутун",
            text: "При патување од една во друга земја на ЕУ, може да носите тутунски и алкохолни производи само за лична употреба, но не и за препродажба. Правилата не важат за патници помлади од 17 години, на кои не им е дозволено да носат алкохол или тутун.",
          },
          {
            title: "Готовина",
            text: "Ако патувате во земји на ЕУ со 10.000 евра или повеќе во готовина или противвредност во друга валута, мора да го пријавите износот кај царинските органи.",
          },
          {
            title: "Пасош / Виза",
            text: "Патникот мора да има важечки пасош. Пасошот треба да важи најмалку 3 месеци по планираното напуштање на земјата на ЕУ и да биде издаден во последните 10 години. Граничните службеници можат да побараат дополнителни документи како покана, доказ за сместување или повратен билет.",
          },
          {
            title: "Несреќи - надомест и помош",
            text: "Ако патник е повреден во автобусна несреќа за време на долго патување, има право на надомест според полисата за осигурување. Доколку е потребно, превозникот ќе обезбеди итна помош, храна, облека, транспорт или сместување.",
          },
          {
            title: "Безбедност во автобус",
            text: "Патувањето со автобус е еден од најбезбедните начини на транспорт. Безбедноста на нашите клиенти ја сфаќаме многу сериозно. Нашите автобуси се во добра состојба и зад воланот се дозволени само квалификувани возачи.",
          },
          {
            title: "Промени во возниот ред",
            text: "Времето на поаѓање и пристигнување секогаш се чита според локалното време. Bashkim Tours не презема одговорност за доцнења или загуби предизвикани од патниците. Патниците треба да проверат 48 часа пред поаѓање дали има можни промени во возниот ред.",
          },
        ],
      }
    : locale === "sq"
